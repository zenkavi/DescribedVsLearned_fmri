...
do
  for reg_rt in 0 1
  do
    aws s3 sync s3://described-vs-experienced/bids_nifti_wface/derivatives/nilearn/glm/level1/$modelnum_reg-rt$reg_rt $DATA_PATH/$modelnum_reg-rt$reg_rt
    ...
    aws s3 sync $L3_PATH/$modelnum_reg-rt$reg_rt s3://described-vs-experienced/bids_nifti_wface/derivatives/nilearn/glm/level3/$modelnum_reg-rt$reg_rt/
  done
done
