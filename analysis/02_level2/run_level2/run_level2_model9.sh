...
do
  ...
  do
    ...
    do
      for tfce in 1
      do
        for regname in fractalProb_ev fractalProb_par stim_ev choiceShift_st valBundleSumEarly_par valChosenMinusUnchosenLate_par reward_ev reward_par rpeLeftRightSumEarly_par rewardedAttrSurprise_par rewarded_st notRewarded_st
        do
          for reg_rt in 0
          do
            for package in fsl
