...
do
  ...
  do
    ...
    docker run --rm -it -v $L1_PATH:/data -v $L2_PATH:/out -v $CODE_PATH:/code zenkavi/fsl:6.0.3 ./code/00_sandbox/get_mean_desmat_cor.py --l1_path /data --l3_path /out --mnum $modelnum --reg_rt $reg_rt
